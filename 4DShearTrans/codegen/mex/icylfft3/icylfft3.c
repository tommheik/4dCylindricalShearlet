...
static emlrtRSInfo emlrtRSI = { 4,     /* lineNo */
  "icylfft3",                          /* fcnName */
  "G:\\4dCylindricalShearlet\\4DShearTrans\\icylfft3.m"/* pathName */
};

static emlrtRSInfo b_emlrtRSI = { 79,  /* lineNo */
  "ifft",                              /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\lib\\matlab\\datafun\\ifft.m"/* pathName */
};
...
static emlrtRTEInfo emlrtRTEI = { 79,  /* lineNo */
  1,                                   /* colNo */
  "ifft",                              /* fName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\lib\\matlab\\datafun\\ifft.m"/* pName */
};
...
static emlrtRTEInfo c_emlrtRTEI = { 4, /* lineNo */
  1,                                   /* colNo */
  "icylfft3",                          /* fName */
  "G:\\4dCylindricalShearlet\\4DShearTrans\\icylfft3.m"/* pName */
};
              ...
              emxArray_real32_T *f)
{
  ...
  if ((F->size[0] == 0) || (F->size[1] == 0) || (F->size[2] == 0) || (F->size[3]
    ...
    emlrtFFTWF_1D_C2C((real32_T *)&F->data[0], (real32_T *)&y->data[0], 1,
                      F->size[0], F->size[0], i, 1);
  }
  ...
  if ((b_y->size[0] == 0) || (b_y->size[1] == 0) || (b_y->size[2] == 0) ||
    ...
    emlrtFFTWF_1D_C2C((real32_T *)&b_y->data[0], (real32_T *)&y->data[0], i,
  ...
  f->size[3] = y->size[3];
  f->size[4] = y->size[4];
  emxEnsureCapacity_real32_T(sp, f, i, &c_emlrtRTEI);
  loop_ub = y->size[0] * y->size[1] * y->size[2] * y->size[3] * y->size[4];
  for (i = 0; i < loop_ub; i++) {
    f->data[i] = y->data[i].re;
  }
...
/* End of code generation (icylfft3.c) */
