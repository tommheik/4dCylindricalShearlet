...
void icylfft3_mexFunction(int32_T nlhs, mxArray *plhs[1], int32_T nrhs, const
  mxArray *prhs[1])
{
  ...
  /* Call the function. */
  icylfft3_api(prhs, nlhs, outputs);
                 ...
                 *prhs[])
{
  ...
  if (setjmp(emlrtJBEnviron) == 0) {
    ...
    icylfft3_mexFunction(nlhs, plhs, nrhs, prhs);
...
/* End of code generation (_coder_icylfft3_mex.c) */
